...
function createProgram(internalOptions) {
  const program = (0, import_commander.createCommand)().version("1.3.5").allowExcessArguments(false).configureHelp({ showGlobalOptions: true, sortOptions: true, sortSubcommands: true });
